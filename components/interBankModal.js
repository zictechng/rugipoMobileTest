...
const InterBankModal = (props) => {

    closeModal = (bool, data) =>{
        props.loanModalVisible(bool);
       }
  return (
    <View
        disabled={true}
         ...
         animation='fadeInUp'
            ...
            <View style={styles.textView}>
                <View style={{backgroundColor: colors.secondaryColor2, 
                    ...
                    <Text style={[styles.text, {fontSize: 20, color:'#fff'}]}>Inter Bank Transfer</Text>
                </View>
                
                <View style={{marginTop: 20, marginBottom: 8}}>
                    
                            <View style={{justifyContent: 'center', alignItems: 'center', marginBottom: 10}}>
                             <Image source={require('../assets/bank.png')} style={{width:60, height:60, tintColor: colors.secondaryColor2}}  />
                            </View>
                            ...
                            <View style={styles.rowWrapper2}>
                                <View style={styles.row}>
                                  <Text style={[styles.rowLabel, {fontSize: 15, fontFamily: '_regular'}]}>
                                    Sorry, inter bank transfer is currently unavailable at your location!
